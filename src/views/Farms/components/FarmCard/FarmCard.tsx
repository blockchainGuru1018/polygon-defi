...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account, wethPrice, aavePrice, dmaPrice }) => {
  ...
  }, [bnbPrice, cakePrice, farm.lpTotalInQuoteToken, farm.quoteTokenSymbol, wethPrice, dmaPrice, aavePrice])
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'YORK' && <StyledCardAccent />}
