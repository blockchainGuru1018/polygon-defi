...
import { useFarms, usePriceBnbBusd, usePriceCakeBusd, usePriceWethBusd, usePriceBtcBusd, usePriceDmaBusd, usePriceAaveBusd } from 'state/hooks'
...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  const farmsList = useCallback(
    ...
    [bnbPrice, account, cakePrice, ethereum, wethPrice, aavePrice, dmaPrice],
  )
  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="primary" mb="50px" style={{ textAlign: 'center' }}>
        {
          tokenMode ?
            TranslateString(10002, 'Stake tokens to earn YORK')
            :
          TranslateString(320, 'Stake LP tokens to earn YORK')
        }
      </Heading>
      <Heading as="h2" color="secondary" mb="50px" style={{ textAlign: 'center' }}>
        {TranslateString(10000, 'Deposit Fee will be used to buyback YORK')}
      </Heading>
